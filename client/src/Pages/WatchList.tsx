...
export const WatchList = () => {
    ...
    const watchlist = useSelector<AppStateType>((state: AppStateType) => state.user.watchlist) as Watchlist[];
                      ...
                      <List.Item>
                          <Card
                              ...
                              actions={[
                                  ...
                                  <Tooltip title="Remove from list">
                                      <Button type="ghost" shape="circle" icon={ <DeleteOutlined key="ellipsis"/>} />
                                  </Tooltip>
                          ...
                          >
                              <div className="watchlist-content">
                                  ...
                                  <p>Genres</p>
                                  {movie.genre_ids.map((genre) =><Tag className="genre-tag" key={genre} color="volcano">{genre}</Tag>)}
                              </div>
